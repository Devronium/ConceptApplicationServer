...
#ifndef _WIN32HACK_H_
#define _WIN32HACK_H_
#include <windows.h>
 ...
 * --*/
    ...
    *pptResult = NULL;
    ...
    if (pszServiceName) {
        wPort = (WORD)strtol(pszServiceName, &pc, 10);
...
int WSAAPI getnameinfo(const struct sockaddr *sa, socklen_t salen, char *host, DWORD hostlen,
