 ...
 */
extern int mustach_file(const char *template_, size_t length, const struct mustach_itf *itf, void *closure, int flags, FILE *file);
 ...
 * a other negative value in case of error.
 */
extern int mustach_fd(const char *template_, size_t length, const struct mustach_itf *itf, void *closure, int flags, int fd);
 ...
 * a other negative value in case of error.
 */
extern int mustach_mem(const char *template_, size_t length, const struct mustach_itf *itf, void *closure, int flags, char **result, size_t *size);
 ...
 * a other negative value in case of error.
 */
DEPRECATED_MUSTACH(extern int fmustach(const char *template_, const struct mustach_itf *itf, void *closure, FILE *file));
 ...
 * a other negative value in case of error.
 */
DEPRECATED_MUSTACH(extern int fdmustach(const char *template_, const struct mustach_itf *itf, void *closure, int fd));
 ...
 * a other negative value in case of error.
 */
DEPRECATED_MUSTACH(extern int mustach(const char *template_, const struct mustach_itf *itf, void *closure, char **result, size_t *size));
