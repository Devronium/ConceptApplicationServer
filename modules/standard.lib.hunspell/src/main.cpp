...
CONCEPT_FUNCTION_IMPL(Hunspell_create, 2)
    T_STRING(Hunspell_create, 0)
    T_STRING(Hunspell_create, 1)
...
CONCEPT_FUNCTION_IMPL(Hunspell_create_key, 3)
    T_STRING(Hunspell_create_key, 0)
    T_STRING(Hunspell_create_key, 1)
    T_STRING(Hunspell_create_key, 2)
    Hunhandle * hun = Hunspell_create_key(PARAM(0), PARAM(1), PARAM(2));
    RETURN_NUMBER((SYS_INT)hun);
END_IMPL
//---------------------------------------------------------------------------
CONCEPT_FUNCTION_IMPL(Hunspell_destroy, 1)
    T_HANDLE(Hunspell_destroy, 0)
...
CONCEPT_FUNCTION_IMPL(Hunspell_spell, 2)
    T_HANDLE(Hunspell_spell, 0)
    T_STRING(Hunspell_spell, 1)
    Hunhandle * hun = (Hunhandle *)(SYS_INT)PARAM(0);
    HUNSPELL_LOCK(hun)
...
CONCEPT_FUNCTION_IMPL(Hunspell_suggest, 2)
    T_HANDLE(Hunspell_suggest, 0)
    T_STRING(Hunspell_suggest, 1)
    CREATE_ARRAY(RESULT);
    Hunhandle *hun    = (Hunhandle *)(SYS_INT)PARAM(0);
    char      **slist = 0;
    HUNSPELL_LOCK(hun)
...
CONCEPT_FUNCTION_IMPL(Hunspell_get_dic_encoding, 1)
    T_HANDLE(Hunspell_get_dic_encoding, 0)
    Hunhandle * hun = (Hunhandle *)(SYS_INT)PARAM(0);
    HUNSPELL_LOCK(hun)
...
CONCEPT_FUNCTION_IMPL(Hunspell_analyze, 2)
    T_HANDLE(Hunspell_analyze, 0)
    T_STRING(Hunspell_analyze, 1)
    CREATE_ARRAY(RESULT);
    Hunhandle *hun    = (Hunhandle *)(SYS_INT)PARAM(0);
    char      **slist = 0;
    HUNSPELL_LOCK(hun)
...
CONCEPT_FUNCTION_IMPL(Hunspell_stem, 2)
    T_HANDLE(Hunspell_stem, 0)
    T_STRING(Hunspell_stem, 1)
    CREATE_ARRAY(RESULT);
    Hunhandle *hun    = (Hunhandle *)(SYS_INT)PARAM(0);
    char      **slist = 0;
    HUNSPELL_LOCK(hun)
...
CONCEPT_FUNCTION_IMPL(Hunspell_stem2, 2)
    T_HANDLE(Hunspell_stem2, 0)
    T_ARRAY(Hunspell_stem2, 1)
    CREATE_ARRAY(RESULT);
    Hunhandle *hun    = (Hunhandle *)(SYS_INT)PARAM(0);
    char      **slist = 0;
...
CONCEPT_FUNCTION_IMPL(Hunspell_generate, 3)
    T_HANDLE(Hunspell_generate, 0)
    T_STRING(Hunspell_generate, 1)
    T_STRING(Hunspell_generate, 2)
    CREATE_ARRAY(RESULT);
    Hunhandle *hun    = (Hunhandle *)(SYS_INT)PARAM(0);
    char      **slist = 0;
    HUNSPELL_LOCK(hun)
...
CONCEPT_FUNCTION_IMPL(Hunspell_generate2, 3)
    T_HANDLE(Hunspell_generate2, 0)
    T_STRING(Hunspell_generate2, 1)
    T_ARRAY(Hunspell_generate2, 2)
...
CONCEPT_FUNCTION_IMPL(Hunspell_add, 2)
    T_HANDLE(Hunspell_add, 0)
    T_STRING(Hunspell_add, 1)
    Hunhandle * hun = (Hunhandle *)(SYS_INT)PARAM(0);
    HUNSPELL_LOCK(hun)
...
CONCEPT_FUNCTION_IMPL(Hunspell_add_with_affix, 3)
    T_HANDLE(Hunspell_add_with_affix, 0)
    T_STRING(Hunspell_add_with_affix, 1)
    T_STRING(Hunspell_add_with_affix, 2)
    Hunhandle * hun = (Hunhandle *)(SYS_INT)PARAM(0);
    HUNSPELL_LOCK(hun)
...
CONCEPT_FUNCTION_IMPL(Hunspell_remove, 2)
    T_HANDLE(Hunspell_remove, 0)
    T_STRING(Hunspell_remove, 1)
    Hunhandle * hun = (Hunhandle *)(SYS_INT)PARAM(0);
    HUNSPELL_LOCK(hun)
