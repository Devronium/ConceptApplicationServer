...
CONCEPT_FUNCTION_IMPL(purple_account_set_register_callback, 2)
    T_NUMBER(0)     // PurpleAccount*
    T_DELEGATE(1)   // PurpleAccountRegistrationCb
...
CONCEPT_FUNCTION_IMPL(purple_account_unregister, 2)
    T_NUMBER(0)     // PurpleAccount*
    T_DELEGATE(1)   // PurpleAccountUnregistrationCb
...
CONCEPT_FUNCTION_IMPL(purple_account_request_authorization, 8)
    ...
    T_STRING(4)     // char*
    T_NUMBER(5)     // int
    T_DELEGATE(6)   // PurpleAccountRequestAuthorizationCb
    T_DELEGATE(7)   // PurpleAccountRequestAuthorizationCb
//T_NUMBER(8) // void*
...
CONCEPT_FUNCTION_IMPL(purple_account_get_status_type_with_primitive, 2)
    T_NUMBER(0)     // PurpleAccount*
    T_NUMBER(1)     // PurpleStatusPrimitive
...
CONCEPT_FUNCTION_IMPL(purple_account_option_destroy, 1)
    T_NUMBER(0)     // PurpleAccountOption*
...
CONCEPT_FUNCTION_IMPL(purple_account_user_split_destroy, 1)
    T_NUMBER(0)     // PurpleAccountUserSplit*
...
CONCEPT_FUNCTION_IMPL(purple_blist_update_buddy_status, 2)
    T_NUMBER(0)     // PurpleBuddy*
    T_NUMBER(1)     // PurpleStatus*
...
CONCEPT_FUNCTION_IMPL(purple_blist_add_buddy, 4)
    T_NUMBER(0)     // PurpleBuddy*
    T_NUMBER(1)     // PurpleContact*
    T_NUMBER(2)     // PurpleGroup*
    T_NUMBER(3)     // PurpleBlistNode*
...
CONCEPT_FUNCTION_IMPL(purple_blist_node_set_flags, 2)
    T_NUMBER(0)     // PurpleBlistNode*
    T_NUMBER(1)     // PurpleBlistNodeFlags
...
CONCEPT_FUNCTION_IMPL(purple_buddy_icon_get_scale_size, 3)
    T_NUMBER(0)     // PurpleBuddyIconSpec*
...
CONCEPT_FUNCTION_IMPL(purple_certificate_verify, 4)
    T_NUMBER(0)     // PurpleCertificateVerifier*
    T_STRING(1)     // char*
    T_NUMBER(2)     // GList*
    T_DELEGATE(3)
...
CONCEPT_FUNCTION_IMPL(purple_certificate_verify_complete, 2)
    T_NUMBER(0)
    T_NUMBER(1)     // PurpleCertificateVerificationStatus
...
CONCEPT_FUNCTION_IMPL(purple_certificate_import, 2)
    T_NUMBER(0)     // PurpleCertificateScheme*
    T_STRING(1)     // char*
...
CONCEPT_FUNCTION_IMPL(purple_certificate_pool_mkpath, 2)
    T_NUMBER(0)     // PurpleCertificatePool*
    T_STRING(1)     // char*
...
CONCEPT_FUNCTION_IMPL(purple_cipher_context_set_option, 3)
    T_NUMBER(0)     // PurpleCipherContext*
    T_STRING(1)     // char*
    T_NUMBER(2)     // gpointer
...
CONCEPT_FUNCTION_IMPL(purple_cipher_context_set_batch_mode, 2)
    T_NUMBER(0)     // PurpleCipherContext*
    T_NUMBER(1)     // PurpleCipherBatchMode
...
CONCEPT_FUNCTION_IMPL(purple_cmd_register, 7)
    T_STRING(0)     // char*
    T_STRING(1)     // char*
    T_NUMBER(2)     // PurpleCmdPriority
    T_NUMBER(3)     // PurpleCmdFlag
    T_STRING(4)     // char*
    T_DELEGATE(5)   // PurpleCmdFunc
    T_STRING(6)     // char*
...
CONCEPT_FUNCTION_IMPL(purple_connection_set_state, 2)
    T_NUMBER(0)     // PurpleConnection*
    T_NUMBER(1)     // PurpleConnectionState
...
CONCEPT_FUNCTION_IMPL(purple_connection_error_reason, 3)
    T_NUMBER(0)     // PurpleConnection*
    T_NUMBER(1)     // PurpleConnectionError
    T_STRING(2)     // char*
...
CONCEPT_FUNCTION_IMPL(purple_connection_error_is_fatal, 1)
    T_NUMBER(0)     // PurpleConnectionError
...
CONCEPT_FUNCTION_IMPL(purple_conversation_new, 3)
    T_NUMBER(0)     // PurpleConversationType
    T_NUMBER(1)     // PurpleAccount*
    T_STRING(2)     // char*
...
CONCEPT_FUNCTION_IMPL(purple_conversation_set_features, 2)
    T_NUMBER(0)     // PurpleConversation*
    T_NUMBER(1)     // PurpleConnectionFlags
...
CONCEPT_FUNCTION_IMPL(purple_conversation_update, 2)
    T_NUMBER(0)     // PurpleConversation*
    T_NUMBER(1)     // PurpleConvUpdateType
...
CONCEPT_FUNCTION_IMPL(purple_conv_chat_add_user, 5)
    ...
    T_STRING(1)     // char*
    T_STRING(2)     // char*
    T_NUMBER(3)     // PurpleConvChatBuddyFlags
    T_NUMBER(4)     // int
...
CONCEPT_FUNCTION_IMPL(purple_conv_chat_user_set_flags, 3)
    T_NUMBER(0)     // PurpleConvChat*
    T_STRING(1)     // char*
    T_NUMBER(2)     // PurpleConvChatBuddyFlags
...
CONCEPT_FUNCTION_IMPL(purple_input_add, 3)
    T_NUMBER(0)     // int
    T_NUMBER(1)     // PurpleInputCondition
//T_NUMBER(2) // PurpleInputFunction
    T_DELEGATE(2)   // gpointer
...
CONCEPT_FUNCTION_IMPL(purple_eventloop_set_ui_ops, 1)
    T_NUMBER(0)     // PurpleEventLoopUiOps*
...
CONCEPT_FUNCTION_IMPL(purple_log_new, 5)
    T_NUMBER(0)     // PurpleLogType
    T_STRING(1)     // char*
    T_NUMBER(2)     // PurpleAccount*
    T_NUMBER(3)     // PurpleConversation*
    T_NUMBER(4)     // time_t
...
CONCEPT_FUNCTION_IMPL(purple_media_candidate_new, 6)
    T_STRING(0)     // char*
    T_NUMBER(1)     // guint
    T_NUMBER(2)     // PurpleMediaCandidateType
    T_NUMBER(3)     // PurpleMediaNetworkProtocol
    T_STRING(4)     // char*
    T_NUMBER(5)     // guint
...
CONCEPT_FUNCTION_IMPL(purple_media_candidate_get_foundation, 1)
    T_NUMBER(0)     // PurpleMediaCandidate*
...
CONCEPT_FUNCTION_IMPL(purple_media_codec_new, 4)
    T_NUMBER(0)     // int
    T_STRING(1)     // char*
    T_NUMBER(2)     // PurpleMediaSessionType
    T_NUMBER(3)     // guint
...
CONCEPT_FUNCTION_IMPL(purple_media_stream_info, 5)
    T_NUMBER(0)     // PurpleMedia*
    T_NUMBER(1)     // PurpleMediaInfoType
    T_STRING(2)     // char*
    T_STRING(3)     // char*
    T_NUMBER(4)     // int
...
CONCEPT_FUNCTION_IMPL(purple_media_add_stream, 8)
    ...
    T_STRING(1)     // char*
    T_STRING(2)     // char*
    T_NUMBER(3)     // PurpleMediaSessionType
    T_NUMBER(4)     // int
    T_STRING(5)     // char*
    T_NUMBER(6)     // guint
    T_NUMBER(7)
...
CONCEPT_FUNCTION_IMPL(purple_network_listen, 3)
    T_NUMBER(0)     // unsigned short
    T_NUMBER(1)     // int
    T_DELEGATE(2)   // PurpleNetworkListenCallback
...
CONCEPT_FUNCTION_IMPL(purple_network_listen_range, 4)
    ...
    T_NUMBER(1)     // unsigned short
    T_NUMBER(2)     // int
    T_DELEGATE(3)   // PurpleNetworkListenCallback
...
CONCEPT_FUNCTION_IMPL(purple_network_listen_cancel, 1)
    T_NUMBER(0)     // PurpleNetworkListenData*
...
CONCEPT_FUNCTION_IMPL(purple_notify_searchresults, 6)
    ...
    T_STRING(2)     // char*
    T_STRING(3)     // char*
    T_NUMBER(4)     // PurpleNotifySearchResults*
    T_DELEGATE(5)   // PurpleNotifyCloseCallback
//T_NUMBER(6) // void*
...
CONCEPT_FUNCTION_IMPL(purple_notify_searchresults_free, 1)
    T_NUMBER(0)     // PurpleNotifySearchResults*
...
CONCEPT_FUNCTION_IMPL(purple_notify_searchresults_new_rows, 3)
    T_NUMBER(0)     // PurpleConnection*
    T_NUMBER(1)     // PurpleNotifySearchResults*
    T_NUMBER(2)     // void*
...
CONCEPT_FUNCTION_IMPL(purple_notify_searchresults_button_add, 3)
    T_NUMBER(0)     // PurpleNotifySearchResults*
    T_NUMBER(1)     // PurpleNotifySearchButtonType
    T_DELEGATE(2)   // PurpleNotifySearchResultsCallback
...
CONCEPT_FUNCTION_IMPL(purple_notify_searchresults_column_add, 2)
    T_NUMBER(0)     // PurpleNotifySearchResults*
    T_NUMBER(1)     // PurpleNotifySearchColumn*
...
CONCEPT_FUNCTION_IMPL(purple_notify_message, 6)
    T_NUMBER(0)     // void*
    T_NUMBER(1)     // PurpleNotifyMsgType
    T_STRING(2)     // char*
    T_STRING(3)     // char*
    T_STRING(4)     // char*
    T_DELEGATE(5)   // PurpleNotifyCloseCallback
...
CONCEPT_FUNCTION_IMPL(purple_notify_emails, 8)
    ...
    T_NUMBER(1)     // size_t
    T_NUMBER(2)     // int
    T_DELEGATE(7)   // PurpleNotifyCloseCallback
//T_NUMBER(8) // void*
...
CONCEPT_FUNCTION_IMPL(purple_notify_userinfo, 4)
    T_NUMBER(0)     // PurpleConnection*
    T_STRING(1)     // char*
    T_NUMBER(2)     // PurpleNotifyUserInfo*
    T_DELEGATE(3)   // PurpleNotifyCloseCallback
//T_NUMBER(4) // void*
...
CONCEPT_FUNCTION_IMPL(purple_notify_user_info_destroy, 1)
    T_NUMBER(0)     // PurpleNotifyUserInfo*
...
CONCEPT_FUNCTION_IMPL(purple_notify_user_info_entry_get_label, 1)
    T_NUMBER(0)     // PurpleNotifyUserInfoEntry*
...
CONCEPT_FUNCTION_IMPL(purple_notify_user_info_entry_set_type, 2)
    T_NUMBER(0)     // PurpleNotifyUserInfoEntry*
    T_NUMBER(1)     // PurpleNotifyUserInfoEntryType
...
/*CONCEPT_FUNCTION_IMPL(purple_plugin_ipc_register,6)
        T_NUMBER(0) // PurplePlugin*
        T_STRING(1) // char*
        T_NUMBER(2) // PurpleCallback
        T_NUMBER(3) // PurpleSignalMarshalFunc
        T_NUMBER(4) // PurpleValue*
        T_NUMBER(5) // int
...
CONCEPT_FUNCTION_IMPL(purple_plugin_pref_frame_destroy, 1)
    T_NUMBER(0)     // PurplePluginPrefFrame*
...
CONCEPT_FUNCTION_IMPL(purple_plugin_pref_set_type, 2)
    T_NUMBER(0)     // PurplePluginPref*
    T_NUMBER(1)     // PurplePluginPrefType
...
CONCEPT_FUNCTION_IMPL(purple_plugin_pref_set_format_type, 2)
    T_NUMBER(0)     // PurplePluginPref*
    T_NUMBER(1)     // PurpleStringFormatType
...
CONCEPT_FUNCTION_IMPL(purple_pounce_new, 5)
    ...
    T_NUMBER(1)     // PurpleAccount*
    T_STRING(2)     // char*
    T_NUMBER(3)     // PurplePounceEvent
    T_NUMBER(4)     // PurplePounceOption
...
CONCEPT_FUNCTION_IMPL(purple_prefs_connect_callback, 3)
    T_NUMBER(0)     // void*
    T_STRING(1)     // char*
    T_DELEGATE(2)   // PurplePrefCallback
//T_NUMBER(3) // void*
...
CONCEPT_FUNCTION_IMPL(purple_proxy_connect, 5)
    ...
    T_STRING(2)     // char*
    T_NUMBER(3)     // int
    T_DELEGATE(4)   // PurpleProxyConnectFunction
//T_NUMBER(5) // void*
...
CONCEPT_FUNCTION_IMPL(purple_proxy_connect_cancel, 1)
    T_NUMBER(0)     // PurpleProxyConnectData*
...
CONCEPT_FUNCTION_IMPL(purple_attention_type_set_name, 2)
    T_NUMBER(0)     // PurpleAttentionType*
    T_STRING(1)     // char*
...
CONCEPT_FUNCTION_IMPL(purple_request_fields_destroy, 1)
    T_NUMBER(0)     // PurpleRequestFields*
...
CONCEPT_FUNCTION_IMPL(purple_request_fields_add_group, 2)
    T_NUMBER(0)     // PurpleRequestFields*
    T_NUMBER(1)     // PurpleRequestFieldGroup*
...
CONCEPT_FUNCTION_IMPL(purple_request_field_group_destroy, 1)
    T_NUMBER(0)     // PurpleRequestFieldGroup*
...
CONCEPT_FUNCTION_IMPL(purple_request_field_new, 3)
    T_STRING(0)     // char*
    T_STRING(1)     // char*
    T_NUMBER(2)     // PurpleRequestFieldType
...
/*CONCEPT_FUNCTION_IMPL(purple_request_field_account_get_filter,1)
   ...
   CONCEPT_FUNCTION_IMPL(purple_request_input,16)
        ...
        T_STRING(7) // char*
        T_STRING(8) // char*
        T_NUMBER(9) // GCallback
        T_STRING(10) // char*
        T_NUMBER(11) // GCallback
        T_NUMBER(12) // PurpleAccount*
        T_STRING(13) // char*
        T_NUMBER(14) // PurpleConversation*
        T_NUMBER(15) // void*
   ...
   CONCEPT_FUNCTION_IMPL(purple_request_choice,13)
        ...
        T_NUMBER(4) // int
        T_STRING(5) // char*
        T_NUMBER(6) // GCallback
        T_STRING(7) // char*
        T_NUMBER(8) // GCallback
        T_NUMBER(9) // PurpleAccount*
        T_STRING(10) // char*
        T_NUMBER(11) // PurpleConversation*
        T_NUMBER(12) // void*
   ...
   CONCEPT_FUNCTION_IMPL(purple_request_action,10)
        ...
        T_STRING(3) // char*
        T_NUMBER(4) // int
        T_NUMBER(5) // PurpleAccount*
        T_STRING(6) // char*
        T_NUMBER(7) // PurpleConversation*
        T_NUMBER(8) // void*
        T_NUMBER(9) // size_t
   ...
   CONCEPT_FUNCTION_IMPL(purple_request_fields,13)
        ...
        T_STRING(2) // char*
        T_STRING(3) // char*
        T_NUMBER(4) // PurpleRequestFields*
        T_STRING(5) // char*
        T_NUMBER(6) // GCallback
        T_STRING(7) // char*
        T_NUMBER(8) // GCallback
   ...
   CONCEPT_FUNCTION_IMPL(purple_request_file,10)
        ...
        T_STRING(2) // char*
        T_NUMBER(3) // int
        T_NUMBER(4) // GCallback
        T_NUMBER(5) // GCallback
        T_NUMBER(6) // PurpleAccount*
        T_STRING(7) // char*
        T_NUMBER(8) // PurpleConversation*
        T_NUMBER(9) // void*
...
CONCEPT_FUNCTION_IMPL(purple_roomlist_room_new, 3)
    T_NUMBER(0)     // PurpleRoomlistRoomType
    T_STRING(1)     // char*
    T_NUMBER(2)     // PurpleRoomlistRoom*
...
CONCEPT_FUNCTION_IMPL(purple_roomlist_field_new, 4)
    T_NUMBER(0)     // PurpleRoomlistFieldType
    T_STRING(1)     // char*
    T_STRING(2)     // char*
    T_NUMBER(3)     // int
...
CONCEPT_FUNCTION_IMPL(purple_roomlist_field_get_type, 1)
    T_NUMBER(0)     // PurpleRoomlistField*
...
CONCEPT_FUNCTION_IMPL(purple_roomlist_set_ui_ops, 1)
    T_NUMBER(0)     // PurpleRoomlistUiOps*
...
CONCEPT_FUNCTION_IMPL(purple_savedstatus_find_transient_by_type_and_message, 2)
    T_NUMBER(0)     // PurpleStatusPrimitive
    T_STRING(1)     // char*
...
CONCEPT_FUNCTION_IMPL(purple_savedstatus_substatus_get_type, 1)
    T_NUMBER(0)     // PurpleSavedStatusSub*
...
/*CONCEPT_FUNCTION_IMPL(purple_signal_register,5)
        T_NUMBER(0) // void*
        T_STRING(1) // char*
        T_NUMBER(2) // PurpleSignalMarshalFunc
        T_NUMBER(3) // PurpleValue*
        T_NUMBER(4) // int
...
/*
   CONCEPT_FUNCTION_IMPL(purple_ssl_connect,6)
        ...
        T_STRING(1) // char*
        T_NUMBER(2) // int
        T_NUMBER(3) // PurpleSslInputFunction
        T_NUMBER(4) // PurpleSslErrorFunction
        T_NUMBER(5) // void*
   ...
   CONCEPT_FUNCTION_IMPL(purple_ssl_connect_with_host_fd,6)
        T_NUMBER(0) // PurpleAccount*
        T_NUMBER(1) // int
        T_NUMBER(2) // PurpleSslInputFunction
        T_NUMBER(3) // PurpleSslErrorFunction
        T_STRING(4) // char*
        T_NUMBER(5) // void*
   ...
   CONCEPT_FUNCTION_IMPL(purple_ssl_input_add,3)
        T_NUMBER(0) // PurpleSslConnection*
        T_NUMBER(1) // PurpleSslInputFunction
        T_NUMBER(2) // void*
...
CONCEPT_FUNCTION_IMPL(purple_presence_new, 1)
    T_NUMBER(0)     // PurplePresenceContext
...
/*CONCEPT_FUNCTION_IMPL(purple_upnp_init,0)
   ...
   CONCEPT_FUNCTION_IMPL(purple_upnp_cancel_port_mapping,1)
        T_NUMBER(0) // UPnPMappingAddRemove*
...
/*CONCEPT_FUNCTION_IMPL(purple_markup_find_tag,5)
   ...
   CONCEPT_FUNCTION_IMPL(purple_markup_extract_info_field,12)
        ...
        T_NUMBER(9) // int
        T_STRING(10) // char*
        T_NUMBER(11) // PurpleInfoFieldFormatCallback
...
/*
   ...
   CONCEPT_FUNCTION_IMPL(purple_util_fetch_url_request,8)
        ...
        T_STRING(4) // char*
        T_NUMBER(5) // int
        T_NUMBER(6) // PurpleUtilFetchUrlCallback
        T_NUMBER(7) // void*
   ...
   CONCEPT_FUNCTION_IMPL(purple_util_fetch_url_request_len,9)
        ...
        T_NUMBER(5) // int
        T_NUMBER(6) // gssize
        T_NUMBER(7) // PurpleUtilFetchUrlCallback
        T_NUMBER(8) // void*
   ...
   CONCEPT_FUNCTION_IMPL(purple_util_fetch_url_request_len_with_account,10)
        ...
        T_NUMBER(6) // int
        T_NUMBER(7) // gssize
        T_NUMBER(8) // PurpleUtilFetchUrlCallback
        T_NUMBER(9) // void*
...
CONCEPT_FUNCTION_IMPL(purple_util_fetch_url_cancel, 1)
    T_NUMBER(0)     // PurpleUtilFetchUrlData*
