...
CONCEPT_FUNCTION_IMPL(RTP_Destroy, 1)
    T_NUMBER(RTP_Destroy, 0)     // int

    RETURN_NUMBER(RTP_Destroy(PARAM_INT(0)))
END_IMPL
//------------------------------------------------------------------------
CONCEPT_FUNCTION_IMPL(RTP_Send, 5)
    T_NUMBER(RTP_Send, 0)     // int
    T_NUMBER(RTP_Send, 1)     // unsigned int
    T_NUMBER(RTP_Send, 2)     // unsigned char
    T_NUMBER(RTP_Send, 3)     // unsigned short
    T_STRING(RTP_Send, 4)     // unsigned char*
...
CONCEPT_FUNCTION_IMPL(RTP_Build, 5)
    T_NUMBER(RTP_Build, 0)     // int
    T_NUMBER(RTP_Build, 1)     // unsigned int
    T_NUMBER(RTP_Build, 2)     // unsigned char
    T_NUMBER(RTP_Build, 3)     // unsigned short
    T_STRING(RTP_Build, 4)     // unsigned char*
...
CONCEPT_FUNCTION_IMPL(RTP_Add_Send_Addr, 4)
    T_NUMBER(RTP_Add_Send_Addr, 0)     // int
    T_STRING(RTP_Add_Send_Addr, 1)     // char*
    T_NUMBER(RTP_Add_Send_Addr, 2)     // unsigned short
    T_NUMBER(RTP_Add_Send_Addr, 3)     // unsigned char
...
CONCEPT_FUNCTION_IMPL(RTP_Rem_Send_Addr, 4)
    T_NUMBER(RTP_Rem_Send_Addr, 0)     // int
    T_STRING(RTP_Rem_Send_Addr, 1)     // char*
    T_NUMBER(RTP_Rem_Send_Addr, 2)     // unsigned short
    T_NUMBER(RTP_Rem_Send_Addr, 3)     // unsigned char
...
CONCEPT_FUNCTION_IMPL(RTP_Sd_Pkt, 7)
    T_NUMBER(RTP_Sd_Pkt, 0)     // int
    T_NUMBER(RTP_Sd_Pkt, 1)     // unsigned int
    T_NUMBER(RTP_Sd_Pkt, 2)     // unsigned char
    T_NUMBER(RTP_Sd_Pkt, 3)     // unsigned short
    T_STRING(RTP_Sd_Pkt, 4)     // unsigned char*
    T_NUMBER(RTP_Sd_Pkt, 5)     // int
    T_NUMBER(RTP_Sd_Pkt, 6)     // unsigned char
...
CONCEPT_FUNCTION_IMPL(RTP_Receive, 4)
    T_NUMBER(RTP_Receive, 0)     // int
    T_NUMBER(RTP_Receive, 1)     // int
