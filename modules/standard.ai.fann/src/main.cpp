...
CONCEPT_FUNCTION_IMPL(_fann_set_activation_function, 4)
    T_NUMBER(0)     // fann*
    T_NUMBER(1)     // fann_activationfunc_enum
    T_NUMBER(2)     // int
    T_NUMBER(3)     // int
...
CONCEPT_FUNCTION_IMPL(_fann_set_train_error_function, 2)
    T_NUMBER(0)     // fann*
    T_NUMBER(1)     // fann_errorfunc_enum
