...
/* i don't like appearing to use GET_printf_HANDLER() */
#define rtf_output    GET_printf_HANDLER()
...
do_help(void) {
    do_version();
    GET_printf_HANDLER() ("(c) Dom Lachowicz 2000\n");
    GET_printf_HANDLER() ("Usage:\n");
    GET_printf_HANDLER() ("\t-c --charset=set\n");
    GET_printf_HANDLER() ("\t-p --password=pass\n");
    GET_printf_HANDLER() ("\t-v --version\n");
    GET_printf_HANDLER() ("\t-? --help\n");
