...
#define ERR940      "Only 'function' can be 'static' and/or 'async'"
...
#define ERR1318     "Green threads cannot be async (or use await)"
#define ERR1319     "Uncaught exception in Promise"
