...
var ConceptHighlightRules = function() {
    var keywordMapper = this.createKeywordMapper({
        ...
        "keyword": "if|else|for|while|do|echo|return|try|catch|throw|break|continue|new|delete|class|function|private|public|event|property|set|get|extends|include|import|triggers|var|operator|typeof|classof|define|length|override|value|this|protected|this|pragma|static|on|off|super|true|false|finalize|null|switch|case|default|array|string|number|object|delegate|__gpu|__parallel|async|await",
