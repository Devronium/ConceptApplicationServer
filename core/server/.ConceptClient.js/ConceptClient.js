		...
		switch (EVENT_ID) {
			...
			case EVENT_ON_BUTTONPRESS:
				var event_function = function(e) {
					...
					if (self.EmulateUserEvent)
						self.EmulateUserEvent();
					if (self.isIE)
						e.cancelBubble = true;
					else
						e.stopPropagation();
				...
				if (mobileAndTabletcheck())
					element.addEventListener("touchstart", event_function);
				else
					element.onmousedown = event_function;
				break;
			case EVENT_ON_BUTTONRELEASE:
				...
				if (mobileAndTabletcheck()) {
					element.addEventListener("touchend", event_function);
					element.addEventListener("touchcancel", event_function);
				} else
					element.onmouseup = event_function;
				break;
			case EVENT_ON_HIDE:
